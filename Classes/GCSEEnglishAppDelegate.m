//
//  GCSEEnglishAppDelegate.m
//  GCSEEnglish
//
//  Created by Joseph caxton-Idowu on 03/05/2011.
...
static NSString* const kAnalyticsAccountId = @"UA-31959009-1";

@implementation GCSEEnglishAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    if (![[GANTracker sharedTracker] trackEvent:@"English iPhone Started"
                                         action:@"Launch iOS"
                                          label:@"Launch iOS"
                                          value:99
                                      withError:&error]) {
